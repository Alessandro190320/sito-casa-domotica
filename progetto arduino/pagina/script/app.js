...
setTimeout(() => {  document.getElementById("corpo").style.display = "block"; }, 1000); // il setTimeout serve per far accadere qualcosa
...
setTimeout(() => {  document.getElementById("caricamento").style.display = "none"; }, 1000);
